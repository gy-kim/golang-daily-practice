...
const (
	...
	// SQL statemets as constants (to reduce duplication and maintenance in tests)
...
var (
	...
	// ErrNotFound is returned when the no recirds where matched by the query
...
// Person is the data transfer objecty (DTO) for this package
type Person struct {
	...
	// currency is the currency this peson has paid in
	Currency string
