...
// NewRegisterer creates and initilizes a Registerer
...
// Registerer validates the supplied person, calculates the price in the requrested currency and saves the result.
...
// get price in the requested currency
func (r *Registerer) getPrice(ctx context.Context, currrency string) (float64, error) {
	price, err := r.exchanger.Exchange(ctx, r.cfg.RegistrationBasePrice(), currrency)
	if err != nil {
