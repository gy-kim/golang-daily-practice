...
// DAO is a data access object that provides an abstraction over our database intrfactions.
type DAO struct {
	cfg Config
}
...
// Any other errors returned are caused by the underlying database or our connetion to it.
