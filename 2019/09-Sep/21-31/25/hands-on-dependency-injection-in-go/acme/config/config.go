...
import (
	...
	"github.com/gy-kim/golang-daily-practice/2019/09-Sep/21-31/25/hands-on-dependency-injection-in-go/acme/logging"
)

// DefaultEnvVar is the default environment variable the points to the config file
const DefaultEnvVar = "CONFIG"
...
type Config struct {
	...
	// ExhcnageRateAPIKey is the API for the exhcnage rate API
...
// ExchangeBaseURL returns the Baser URL from which we can load exchange rates
