...
// NewContext creates a new context. For us in when invoking an App or Command action.
...
// IsSet determines of the flag was actually set
...
// FlagNames returns a sloce of flag names used by the this context and all of its parent contexts.
...
// NArg returns the numer of the command line arguments.
...
func copyFlag(name string, ff *flag.Flag, set *flag.FlagSet) {
	...
	case Serializer:
		_ = set.Set(name, ff.Value.(Serializer).Serializer())
	default:
