...
// Float64Slice wraps []flat64 to satisfy flag.Value
...
// String returns a readable represenatation of this value (for usage defaults)
func (f *Float64Slice) String() string {
	return fmt.Sprintf("%#v", f.slice)
}

// Serialize allows Float64Slice to fulfull Serializer
...
// String returns a readable represenation of this value
...
// Float64Slice looks up the value of a local Float64SliceFlag, returns nil if not founc
