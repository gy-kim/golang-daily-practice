...
// AfterFunc is an action to execute after any subcommands are run, but afte the
...
// ExitErrHandlerFunc is excuted if provided in order to handle exitError values
// returned by Actions and Before/After functions.
type ExitErrHandlerFunc func(context *Context, err error)

// FlagStringFunc is used by the help generation to display a flag, which is
// expected to be a sigle line.
...
// with the environment variable detailed.
